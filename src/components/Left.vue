<template>
    <div class="l-box">
        <div class="dy-form">
            ...
            <div class="dy-room-box" :class="{ error: rnFlag }">
            ...
            <div class="dy-title">
                <span>房间信息</span>
                <span v-if="connectCode !== 100" class="state" :class="{ success: connectCode === 200, fail: connectCode === 400 }">
...
function connection(roomId: string, uniqueId: string) {
    ...
    client.accept = (message: proto.Message) => {
        if (message) {
            ...
            handleChat(msg);
            notification_minecraft(msg, serveruuid.value);
            renewPos();
        }
    };
